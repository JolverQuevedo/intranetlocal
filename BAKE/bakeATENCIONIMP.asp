...
<%
' priemro hay que ver si el item es EITABLE...
' los cargos bancarios aparecen como item de la oc, pero no se pueden atender

cad = " select AR_CESTADO From RSFACCAR..AL0001ARTI Where AR_CCODIGO='"&srv&"' "
rs.open cad, cnn

if rs.recordcount <= 0 then %>
<script language="jscript" type="text/jscript">
    //window.parent.document.all.chks.value = '1'
      parent.window.alert('Articulo no definido en el MAESTRO')
    </script>
