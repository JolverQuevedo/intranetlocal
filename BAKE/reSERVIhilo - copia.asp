		    ...
		    RS.OPEN CAD, CNN%>
		        ...
		        <%if RS.RECORDCOUNT > 0 then%>
                    <tr class="textogris4">
                        ...
                        <td><%=rs("sk_calma")%></td>
                        <td style="text-align:right"><%=FORMATNUMBER(rs("SK_NSKDIS"),3,,,TRUE)%></td>
                        <td style="text-align:right"><%=FORMATNUMBER(rs("RSV"),3,,,TRUE)%></td>
                        <td><%=rs("FEC")%></td>
                    </tr>
		        <%else%>
                    <tr  class="textogris4">
...
function valida(op) {
    ...
    ell = parent.document.getElementById(dd);
     ...
     for (o = 1; o <= maxi; o++) {   
       ...
       // alert(parseFloat(kil) - parseFloat(stk))    
        ...
        if (parseFloat(kil) - (parseFloat(stk)+ parseFloat(RSV)) > 0) {
    ...
    parent.document.getElementById(dd).style.display = 'block'
    //alert(cad)
