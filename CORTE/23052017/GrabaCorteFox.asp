...
queryFox =  " insert into caborden00 (nro_orden,fch_orden,cliente,tela,codtela,colora,[color],ancho,metros,kilos,orpro, " &_
...
" values('" & CT_CNROCORTE & "',ctod('" & CT_DFECHA & "'),'" &CT_CCLIENTE & "','" & left(CT_CDESTEL,40) & "','" & CT_CCODTEL & "','" & CT_CCODCOL & "','" & CT_CDESCOL & "'," & CT_NANCHO & "," & CT_NMETROS & ", " &_
