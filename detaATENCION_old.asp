        ...
        <tr  class="TITULITOcenterROJO" >
           ...
           <%do while noT rs2.eof %>
            <tr ondblclick="ficha22('<%=det%>')" id="fila22<%=Trim(Cstr(det))%>" onmouseover= "this.style.backgroundColor='#7094D6'" onmouseout="this.style.backgroundColor='#C1D3FF'">
                ...
                <td class="DESCRIPTORnegroizq" style="text-align:right;padding-right:5px"><%=formatnumber(RS2("C6_NPREUN1"),2,,,true)%></td>
            ...
            <td colspan="8">
                <table align="left" width="100%" cellpadding="2" cellspacing="2" >
                    <tr>
                        ...
                        <%for i= 0 to 9 %>
                            <td width="6%" class="TALASrojoch" id = 't<%=i%>'></td>
                        <%next %>
                    </tr>
                    <tr>
                        <td class="TALASBLUE22" style="text-align:right; padding-right:10px">QTY</td>
                         <%for i= 0 to 9 %>
                            <td width="6%"><input  id='q<%=i%>' class="TALASBLUE33" onkeyup="this.value=toInt(this.value);" onblur="RECTI()"  /></td>
                        <%next %>
                    </tr>
                </table>
            </td>        
