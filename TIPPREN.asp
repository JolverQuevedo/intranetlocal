...
// **************************************************************
var funcionalidad = 'comun/INSERTBL2.asp?'
...
<form name="thisForm" id="thisForm" method="post" action="tippren.asp">
...
CAD =	" SELECT top  "&pagesize&"  " & _
		" "&pk&","&ds&",  " & _ 
		" USUARIO, FECHA, ESTADO AS EDO,CODREAL AS REAL " & _
		" from "&ALIAS&"  WHERE " & _
        " ESTADO = 'A' and "
...
<!--#include file="COMUN/COMUNtbl22.ASP"-->
<%	RS.Open CAD, Cnn
    SINDATOS =1
	CONT = 1
   		...
   		<td>
            ...
            cellpadding="1" cellspacing="0"  bgcolor="WHITE" border="1" >
              <tr valign="middle"> 
                ...
                <td bgcolor="#FFFFFF" colspan="5"><input type="text" id="DES" name="DES"  style="width:100%"  /></td>
                <td width="10%" bgcolor="<%=(Application("barra"))%>" align="right"> <font face="arial" size="1" color="#000066"><b> 
                  COD. SOFTCOM :</b></font></td>
                <td bgcolor="#FFFFFF" colspan="5"><input type="text" id="REA" name="REA" class="DATOSkhaki" style="width:100%" ondblclick="hlp()"  /></td>
              </tr>
            </table>
         </td>   
        </tr>
