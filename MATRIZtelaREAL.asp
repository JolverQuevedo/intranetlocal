...
'****************************************************
CAD =	" SELECT CODIGO,TIPO,MOVIM,ALMORI,ALMDES,OLDALM, CODSER, ENTREGA,RECIBE,LET1, LET2,CODMOV FROM "&ALIAS&"  ORDER BY TIPO, CODIGO  " 
		'response.Write(cad)
%>
   ...
   <tr>
   		<td>
            ...
            cellpadding="1" cellspacing="0"  bgcolor="WHITE" border="1" >
              ...
              <td width="5%" bgcolor="<%=(Application("barra"))%>" align="RIGHT"> <font face="arial" size="1" color="#000066"><b>MOV REAL</b></font> </td>
            </tr>
            <tr>
               ...
               <td><input type="text" id="LT1" name="LT1" class="DATOS" maxlength="1" /></td>
               <td><input type="text" id="LT2" name="LT2" class="DATOS" maxlength="1" /></td>
               <td><input type="text" id="REA" name="REA" class="DATOS" maxlength="2" /></td>
              </tr>
            </table>
         </td>   
        </tr>
