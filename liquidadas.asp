...
<tr class="titulito">
	...
	<td align="center" colspan="5">
		<font face=arial size= 3 color=DarkBlue><B>OC LIQUIDADAS
		</b></font>
	</td>
...
function tipos() {
    cad = 'liquidadas.asp?tip=' + trim(document.all.TIP.value)
...
function BAKE(ruc) {
    cad = 'BAKE/PROVEEDOR_REAL_liq.asp?pos=' + trim(ruc) + '&URL=' + '../liquidadas.asp?pro='
    /*alert(cad)
