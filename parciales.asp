...
<tr class="titulito">
	...
	<td align="center" colspan="5">
		<font face=arial size= 3 color=DarkBlue><B>OC CON RECEPCION PARCIAL
		</b></font>
	</td>
...
function tipos() {
    cad = 'parciales.asp?tip=' + trim(document.all.TIP.value)
...
function ANALI() {
    ...
    cad = 'Fichaliqui.asp?oc=' + oc + '&tip=' + TIPO + '&sit=' + SIT
...
function BAKE(ruc) {
    cad = 'BAKE/PROVEEDOR_REAL_liq.asp?pos=' + trim(ruc) + '&URL=' + '../PARCIALES.asp?pro='
    /*alert(cad)
