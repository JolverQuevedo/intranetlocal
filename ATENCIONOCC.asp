    ...
    <td width="10%" align="center"><img src="imagenes/atras.gif" style="cursor:pointer;" onclick="javascript: window.location.replace('<%=submenu%>');" /></td>	
          ...
          <td align="center" class="TALASBLUE" width="80%">   
            <table cellpadding="10" cellspacing="1" border="1" bgcolor="#f7d975" align="center" width="100%">
		        <tr><td class="talasblue" align="center">Atenci&oacute;n  O/C COMPRA</td></tr></table></td>
...
<table  border="0" cellspacing="2" cellpadding="2" align="center" width="100%" style="background-color:#DDEBC6" >
    ...
    <tr>
     ...
     <tr>
        ...
        <td colspan="5"><input type="text" id="GLO" name="GLO" value="GS" maxlength="30"  style="width:99%" /></td>
    </tr>
    <tr>
        <td></td>
        <td></td>
...
document.all.head.src= 'bake/bakeOCccab.asp?oc='+ ORDEN + '&cia='+ '<%=cia%>'
}
...
function graba() {
    ...
    kaa  = 'detaAtencionOCC.asp?co=' + strzero(document.all.OC.value,10)  + '&nume=' + trim(document.all.NUME.value)
